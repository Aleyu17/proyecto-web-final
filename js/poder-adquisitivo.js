...
function crearGraficoPoder() {
    ...
    const ctx = document.getElementById('grafico-poder');
    if (ctx) {
        new Chart(ctx, {
            type: 'bar',
            data: {
                ...
                datasets: [
                    {
                        label: 'Gasto (Bs)',
                        data: [simulacionActual.gastoAnterior, simulacionActual.gastoActual],
                        backgroundColor: '#3b82f6',
                        borderRadius: 6
                    },
                    {
                        label: 'Ingreso (Bs)',
                        data: [simulacionActual.ingresoFamiliar, simulacionActual.ingresoFamiliar],
